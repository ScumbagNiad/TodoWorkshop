...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputView, Main, TodoCollection, TodoListView,
	...
	TodoCollection = __webpack_require__(6);

	InputView = __webpack_require__(9);

	TodoListView = __webpack_require__(10);
	...
	Main = (function(superClass) {
	  ...
	  Main.prototype.onSearch = function() {
	    return this.collection.post(this.inputView.value());
	  };

	  Main.prototype.onChange = function(object) {
	    return this.collection.change('change', object.id, object.changed.completed);
	  };

	  Main.prototype.onRemove = function(object) {
	    return this.collection.change('remove', object.id, true);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Request, TodoCollection, TodoModel,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;

	TodoModel = __webpack_require__(7);

	Request = __webpack_require__(8);

	module.exports = TodoCollection = (function(superClass) {
	  ...
	  TodoCollection.prototype.post = function(description) {
	    return Request({
	      method: 'POST',
	  ...
	  TodoCollection.prototype.change = function(action, id, completed) {
	    return Request({
	      method: 'POST',
	  ...
	  TodoCollection.prototype.onRequest = function(error, response, result) {
	    var k, v;
	    for (k in result) {
	      v = result[k];
	  ...
	  TodoCollection.prototype.onChange = function(a, b, c) {
...
/***/ function(module, exports) {
	...
	module.exports = TodoModel = (function(superClass) {
	  extend(TodoModel, superClass);

	  function TodoModel() {
	    this.toggleCompleted = bind(this.toggleCompleted, this);
	    this.initialize = bind(this.initialize, this);
...
/***/ function(module, exports) {
	...
	module.exports = InputView = (function(superClass) {
	  ...
	  InputView.prototype.onKeyUp = function(event) {
	  ...
	  InputView.prototype.search = function() {
	    this.trigger('SEARCH');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TodoItemView, TodoListView,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; },
	  extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
	  hasProp = {}.hasOwnProperty;

	TodoItemView = __webpack_require__(11);
	...
	module.exports = TodoListView = (function(superClass) {
	  ...
	  function TodoListView() {
	    ...
	    this.onDelegateAdd = bind(this.onDelegateAdd, this);
	    this.initialize = bind(this.initialize, this);
	    return TodoListView.__super__.constructor.apply(this, arguments);
	  }

	  TodoListView.prototype.initialize = function(data, delegate) {
	    this.delegate = delegate;
	    return this.delegate.on('add', this.onDelegateAdd);
	  };

	  TodoListView.prototype.onDelegateAdd = function(model, collection) {
	    return this.addItem(model);
	  };

	  TodoListView.prototype.addItem = function(model) {
	    var itemView;
	    itemView = new TodoItemView({
	      model: model
	    });
	    return this.el.appendChild(itemView.el);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = TodoItemView = (function(superClass) {
	  extend(TodoItemView, superClass);

	  function TodoItemView() {
	    this.onModelCompleted = bind(this.onModelCompleted, this);
	    this.onRemoveModel = bind(this.onRemoveModel, this);
	    this.onSwipeRight = bind(this.onSwipeRight, this);
	    this.onSwipeLeft = bind(this.onSwipeLeft, this);
	    this.onClick = bind(this.onClick, this);
	    this.onClickStateButton = bind(this.onClickStateButton, this);
	    this.onClickRemoveButton = bind(this.onClickRemoveButton, this);
	    this.initialize = bind(this.initialize, this);
	  ...
	  TodoItemView.prototype.initialize = function() {
	    ...
	    return Hammer(this.el).on('swiperight', this.onSwipeRight);
	  };
	  ...
	  TodoItemView.prototype.onClickRemoveButton = function() {
	    return this.model.collection.remove(this.model);
	  };

	  TodoItemView.prototype.onClickStateButton = function() {
	    return this.model.toggleCompleted();
	  };

	  TodoItemView.prototype.onClick = function() {
	    return this.model.toggleCompleted();
	  };

	  TodoItemView.prototype.onSwipeLeft = function() {
	    return this.model.collection.remove(this.model);
	  };

	  TodoItemView.prototype.onSwipeRight = function() {
	    return this.model.toggleCompleted();
	  };

	  TodoItemView.prototype.onRemoveModel = function() {
	  ...
	  TodoItemView.prototype.onModelCompleted = function() {
	    return this.el.classList.toggle('completed');
	  };
